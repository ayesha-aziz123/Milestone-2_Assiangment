...
const Navbar = () => {
  ...
  return (
    <div className="container z-50 max-w-[1280px] py-2 px-6 fixed top-0 w-[100vw] bg-[#303043ba] text-white ">
      ...
      {/* Nav 2  */}
      <div className={`nav2 md:hidden fixed top-[65px]  right-0 w-full h-screen backdrop-blur-[20px] bg-[#ffffff30] text-black font-bold z-10 transition-transform duration-500 ease-in-out transform ${
