...
const Contact = () => {
  return (
    <div
      id="contact"
      className="container text-[12px] text-[#cececc] sm:text-[19px]  max-w-[1280px] py-24 mx-auto bg-[#272525] "
    >
      <form>
        ...
        <div className="pt-10  flex flex-col gap-y-3 items-center justify-center mx-auto">
          ...
          <div>
            <button className="rounded-[10px] hover:cursor-pointer text-white text-[20px] bg-[#812939] px-8 py-2">
              Submit
            </button>
          </div>
        </div>
